...
public class SimpleRatingBar extends View {
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        borderColor = arr.getColor(R.styleable.SimpleRatingBar_srb_borderColor, ContextCompat.getColor(getContext(), R.color.gold));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.d(Constant.TAG, "onTouchEvent: " + rating);
                break;
