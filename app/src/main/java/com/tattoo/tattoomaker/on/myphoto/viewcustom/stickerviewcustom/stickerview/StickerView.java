...
//        rotate.setIconEvent(new RotateIconEvent());
        ...
        BitmapStickerIcon flip = new BitmapStickerIcon(getContext(),
                ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_flip), BitmapStickerIcon.LEFT_BOTTOM);
        flip.setIconEvent(new FlipHorizontallyEvent());

        BitmapStickerIcon del = new BitmapStickerIcon(getContext(),
                ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_del), BitmapStickerIcon.LEFT_TOP);
...
//        checkLockNLookSticker(sticker);
    ...
    public Bitmap saveImage(int w, int h) {
        handlingSticker = null;
    ...
    public Bitmap getThumb(Bitmap bitmap) {
        ...
        Bitmap bmOverlay = UtilsBitmap.INSTANCE.overlay(bitmap, bmSticker, false);

        return Bitmap.createScaledBitmap(bmOverlay, 720,
                720 * bmOverlay.getHeight() / bmOverlay.getWidth(), false);
    }
